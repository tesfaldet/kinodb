...
var CommentListView = Backbone.View.extend({
	...
	submitComment: function() {
		...
		this.submitKinoRating(rating, collection.imdbID);
	},
	
	submitKinoRating: function(rating, imdbID) {
		$.ajax({
	...
	toggleComments: function(e) {
		...
		if ($("#comments-list").hasClass("hidden")) {
			...
			$('html, body').animate({scrollTop: $("#comment-toggle-visibility").offset().top - 45}, 'slow');
